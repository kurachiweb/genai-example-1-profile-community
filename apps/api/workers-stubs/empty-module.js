...
// NestJS/@nestjs-apollo が任意機能(WebSocket/microservices/Apollo Federation/Fastify)を
// 未使用でも読み込む(モジュール読み込み時に `class X extends Y {}` する、または
// `mod.SomeClass.register(...)` のようにプロパティ経由でメソッド呼び出しする)ため、
