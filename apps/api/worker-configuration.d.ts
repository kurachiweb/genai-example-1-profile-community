/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1897988305f99a33ee58efa67955611d)
// Runtime types generated with workerd@1.20260701.1 2025-09-23 nodejs_compat
interface __BaseEnv_Env {
	SESSION_CLIENT_KV?: KVNamespace;
	SESSION_ADMIN_KV?: KVNamespace;
	APP_KV?: KVNamespace;
	DB?: D1Database;
	NODE_ENV?: "production";
	DATABASE_URL?: "d1";
	ADMIN_WEBAUTHN_RP_NAME?: "genai-example-1-admin-dev" | "genai-example-1-admin-prod";
	ADMIN_WEBAUTHN_RP_ID?: "genai-example-1-admin-dev.shortbook.workers.dev" | "genai-example-1-admin-prod.shortbook.workers.dev";
	ADMIN_WEBAUTHN_ORIGIN?: "https://genai-example-1-admin-dev.shortbook.workers.dev" | "https://genai-example-1-admin-prod.shortbook.workers.dev";
	CLIENT_ORIGIN?: "https://genai-example-1-client-dev.shortbook.workers.dev" | "https://genai-example-1-client-prod.shortbook.workers.dev";
}
declare namespace Cloudflare {
	...
	interface ProdEnv {
		...
		ADMIN_WEBAUTHN_RP_ID: "genai-example-1-admin-prod.shortbook.workers.dev";
		ADMIN_WEBAUTHN_ORIGIN: "https://genai-example-1-admin-prod.shortbook.workers.dev";
		CLIENT_ORIGIN: "https://genai-example-1-client-prod.shortbook.workers.dev";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "ADMIN_WEBAUTHN_RP_NAME" | "ADMIN_WEBAUTHN_RP_ID" | "ADMIN_WEBAUTHN_ORIGIN" | "CLIENT_ORIGIN">> {}
}
