/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cabcae929e05049ec085bae689cb5e25)
// Runtime types generated with workerd@1.20260625.1 2025-09-23 nodejs_compat
interface __BaseEnv_Env {
	DB?: D1Database;
	NODE_ENV?: "production";
	DATABASE_URL?: "d1";
	API_KEY_RATE_LIMITER?: DurableObjectNamespace<import("./src/worker").ApiKeyRateLimiterDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ApiKeyRateLimiterDurableObject";
	}
	interface DevEnv {
		DB: D1Database;
		NODE_ENV: "production";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL">> {}
}
