...
| Breaking a feature into implementation steps | `ecc-planner` |
| Designing system architecture | `ecc-architect` |
| Reviewing code for bugs or security | `ecc-code-reviewer` or `santa-method` |
...
- `ecc-search-first` — gather external reference material before the council if needed
