...
- `ecc-frontend-patterns` — general React component and state patterns
- `ecc-design-system` — design token and component consistency
- `ecc-motion-ui` — animation patterns with accessibility considerations
