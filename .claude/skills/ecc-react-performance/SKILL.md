...
- Skills: [ecc-react-patterns](../ecc-react-patterns/SKILL.md), [ecc-react-testing](../ecc-react-testing/SKILL.md), [ecc-frontend-patterns](../ecc-frontend-patterns/SKILL.md), [ecc-accessibility](../ecc-accessibility/SKILL.md), [nextjs-turbopack](../nextjs-turbopack/SKILL.md)
- Rules: [rules/ecc-react/](../../rules/ecc-react/)
- Agents: `ecc-react-reviewer` enforces these rules in code review; `ecc-react-build-resolver` handles related build failures
