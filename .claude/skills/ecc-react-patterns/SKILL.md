...
See [rules/ecc-react/hooks.md](../../rules/ecc-react/hooks.md) for the full ruleset. Highlights:
...
- Run `axe` in component tests (see [skills/ecc-react-testing](../ecc-react-testing/SKILL.md))
- Cross-link: [skills/ecc-accessibility/SKILL.md](../ecc-accessibility/SKILL.md) covers WCAG criteria and pattern libraries
...
- Rules: [rules/ecc-react/](../../rules/ecc-react/) — coding-style, hooks, patterns, security, testing
- Skills: [ecc-react-performance](../ecc-react-performance/SKILL.md) for the Vercel-derived performance ruleset, [ecc-frontend-patterns](../ecc-frontend-patterns/SKILL.md) for cross-framework UI concerns, [ecc-accessibility](../ecc-accessibility/SKILL.md), [angular-developer](../angular-developer/SKILL.md) for framework comparison
- Agents: `ecc-react-reviewer` for code review, `ecc-react-build-resolver` for build/bundler errors
