...
Cross-link: [skills/ecc-accessibility/SKILL.md](../ecc-accessibility/SKILL.md) for the broader a11y testing playbook.
...
For any of those, use Playwright Component Testing (component test in real browser) or full E2E. See [ecc-e2e-testing skill](../ecc-e2e-testing/SKILL.md).
...
- Rules: [rules/ecc-react/testing.md](../../rules/ecc-react/testing.md)
- Skills: [ecc-react-patterns](../ecc-react-patterns/SKILL.md), [ecc-accessibility](../ecc-accessibility/SKILL.md), [ecc-e2e-testing](../ecc-e2e-testing/SKILL.md), [ecc-tdd-workflow](../ecc-tdd-workflow/SKILL.md)
- Agents: `ecc-react-reviewer` (reviews test quality during code review), `ecc-tdd-guide` (enforces TDD process)
- Commands: `/ecc-react-test`, `/ecc-react-review`
